        ...
        <div class="row">
            <div class="col-lg-8 event-details-left left-contents" style="background-color:#f9f9ff">
                ...
                <div class="comment-form" style="margin-top:0px">
                    <form action="{{url('/registerApplicantsHouse')}}" method="POST">
                    @csrf
                        ...
                        <div class="form-group form-inline">
                            ...
                            <option datd-display="">Choose Course</option>
                             @foreach ($courses as $obj)
                                            <option value='{{$obj->id}}' @if (old('course_id')=="$obj->id" ) {{ 'selected' }} @endif >
                                         {{ $obj->course_en_name }}</option>
                                           @endforeach
                        </select>
                            </div>
                        ...
                        <div class="form-group form-inline">
                            <div class="form-group col-lg-6 col-md-12">
                                ...
                                <input name="job_title" value="{{ old('job_title') }}" type="text" class="form-control">
                            </div>
                            <div class="form-group col-lg-6 col-md-12">
                                <label>Company*</label>
                        ...
                        <div class="form-group form-inline">
                            <div class="form-group col-lg-12 col-md-12">
                                <textarea class="form-control" name="inhouse_requirements" value="{{ old('inhouse_requirements') }}" style="padding:0px 12px;min-height:200px;">{{Request::old('inhouse_requirements')}}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="popular-post-list">
                                ...
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb" style="width:50%;height:100%">
                                        <img style="border-radius:.5rem;height:70px;width:100%" class="img-fluid" src="{{ asset('uploads/courses')}}/{{ $round->course->course_image_thumbnail }}" alt="{{ $round->course->course_en_name }}">
                                    </div>
                                    <div class="details">
