...
class RoundsApplicantController extends Controller
{
    ...
    public function __construct(Applicant $object)
    {
        ...
        $this->object = $object;
        $this->viewName = 'admin.roundsApplicants.';
        $this->routeName = 'applRound.';
    ...
    {
        $applicants=Applicant::with('courses')->with('round')->where('applicant_type_id', '=',0)->orderBy("created_at", "Desc")->get();
